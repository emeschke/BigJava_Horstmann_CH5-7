...
public class P5_8 {
    ...
    //Main program that reads words (a sentence at a time or one by one?
    //Program loops over all the words calling string Scramble if word length is greater than three, and prints words.

    }
    public static String scramble(String word){
        //if word length is < 4 return word.
        //if word length == 4, flip middle two and return
        //else create a new array, fill 0 and last with the corresponding letters
        //create random object.
        //Need to choose two characters to flip.
        return word;
    }
}
